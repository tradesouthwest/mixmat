...
function php_version_notice() {
        ...
        $message = __( '<strong>MixMat Page Mixer for WordPress</strong> requires PHP version 5.3 or later.
...
define( 'MXMT_URL', plugin_dir_url(__FILE__));
...
function mixmat_scripts() {
    ...
    // Register Styles
    wp_register_style( 'mixmat-style', MXMT_URL . 'css/mixmat-style.css' );
